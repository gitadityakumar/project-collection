...
const About = () => {
  ...
  const handleCopy = () =>{
    navigator.clipboard.writeText('hi@perpetuity.dev');
    setHasCopied(true);
      ...
      <div className="col-span-1 xl:row-span-3 ">
        <div className="grid-container">
          ...
          <div>
            ...
            <p className="grid-subtext">with 1 years of experience , I have honed my skills in frontend and backend develpment , with a focus on animated 3D</p>
          </div>
        </div>
      </div>
      <div className="col-span-1 xl:row-span-3">
          ...
          <div className="col-span-1 xl:row-span-4">
            <div className="grid-container">
              ...
              <div>
                ...
                <p className='grid-subtext'>I'm based in India , with remote work availabe</p>
            ...
            <div className="grid-container">
              ...
              <div className='space-y-2'>
                ...
                <div className='copy-container ' onClick={handleCopy}>
                  ...
                  <p className='lg:text-2xl md:text-xl font-medium text-gray_gradient text-white'>hi@perpetuity.dev</p>
                </div>
              </div>
            </div>
          </div>
